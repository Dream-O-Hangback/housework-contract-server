...
export default (emailCodeDto: EmailCodeDto) => {
    return `
    ...
    * {
    ...
    <!--<![endif]-->
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <h1 class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #363f49;font-size: 26px;line-height: 34px;font-family: ubuntu,sans-serif;text-align: center;user-select: auto;" lang="x-size-30"><span class="font-ubuntu"><strong style="user-select:auto">인증번호 안내</strong></span></h1>
        </div>
        </div>
        ...
        <div class="layout one-col fixed-width has-border stack" style="Margin: 0 auto;max-width: 602px;min-width: 322px; width: 322px;width: calc(28000% - 167398px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #16cbfa;border-top: 1px solid #b7b7ba;border-right: 1px solid #b7b7ba;border-bottom: 1px solid #b7b7ba;border-left: 1px solid #b7b7ba;">
            <!--[if (mso)|(IE)]><table class="layout-has-border" align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #16cbfa;"><td class="border" style="width: 1px;">&#8203;</td><td style="width: 600px" class="w560"><![endif]-->
            <div class="column" style="text-align: left;color: #2b343f;font-size: 17px;line-height: 26px;font-family: Courier New,Courier,monospace;">
        ...
        <div style="mso-line-height-rule: exactly;line-height: 43px;font-size: 1px;">&nbsp;</div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <p style="Margin-top: 0;Margin-bottom: 20px;font-family: ubuntu,sans-serif;text-align: center;user-select: auto;"><span class="font-ubuntu"><strong style="user-select:auto">안녕하세요, 집안일 계약서입니다!</strong></span></p>
        </div>
        </div>
        ...
        <div style="mso-line-height-rule: exactly;line-height: 20px;font-size: 1px;">&nbsp;</div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div class="divider" style="display: block;font-size: 2px;line-height: 2px;Margin-left: auto;Margin-right: auto;width: 40px;background-color: #b7b7ba;Margin-bottom: 20px;">&nbsp;</div>
        </div>
            
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <p class="size-17" style="Margin-top: 0;Margin-bottom: 20px;font-family: ubuntu,sans-serif;font-size: 17px;line-height: 26px;text-align: center;user-select: auto;" lang="x-size-17"><span class="font-ubuntu"><strong style="user-select:auto">인증번호</strong></span></p>
        </div>
        </div>
            
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-family: ubuntu,sans-serif;font-size: 26px;line-height: 34px;text-align: center;user-select: auto;" lang="x-size-30"><span class="font-ubuntu"><span style="color:#16cbfa"><strong style="user-select:auto">${emailCodeDto.code}</strong></span></span></p>
        </div>
        </div>
